...
## Resolution Rules
- Include at minimum: project title with one-line description, Prerequisites, Getting started (verbatim run commands), and Configuration reference; add an API reference section or link when the module exposes a public API.
