...
applyTo: "**/OpenApiConfig.java, **/openapi/**/*.java, **/src/main/resources/application*.yml, **/*Controller.java"
---
...
## Rules
- For `springdoc.*` property placement rules in `application*.yml`, defer to `spring-boot-config.instructions.md`.
