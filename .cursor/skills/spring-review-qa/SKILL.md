...
description: >-
  QA reviewer that validates created or modified files against project rules
  mapped to the qa review topic. Use when reviewing code quality and compliance
  after implementation, or invoking /spring-review-qa. Requires the ADR path and
